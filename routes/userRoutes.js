...
const {  createUser, login, getUserDetails, updateUserInfo, updateUserPassword, existsByEmail, checkNicknameSignup, checkNicknameUpdate, removeUser } = require('../controllers/userController');
